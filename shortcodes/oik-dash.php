 ...
 * We may find buddypress icons in the buddypress plugin
 * 
 *
 * Note: 
 * Default sizes for the fonts are:
 * - dashicons are 20px, 
 * - genericons 16px
 * - buddicons 
...
function bw_dash_enqueue_font( $icon, $atts ) {
  ...
  switch ( $font ) {
    ...
    case "buddicons":
      wp_register_style( 'buddicons', oik_url( 'css/buddicons/buddiicons.css' ), false );
      $font_class = "buddicon";
      break;
...
/**
 * Return a list of buddicons 
 */
function bw_list_buddicons() {
  $bi = array();
  $bi[] = "wp-logo";
  $bi[] = "logo";
  $bi[] = "forums";
